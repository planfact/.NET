...
namespace Core
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            items.Add(new Item { calculationDate = "2020-02-25", contrAgentId = null, value = 123, firstAdditionalOperationAttributeId = 18242, isCalculationCommitted = false, operationCategoryId = null, projectId = null });
            DataForPost dataForPost = new DataForPost { title = "test request", accountBank = null, accountBik = null, accountType = "Cash", active = true, companyId = 41104, currencyCode = "USD", description = null, longTitle = "", remainder = 0, remainderDate = "2020-02-25" };
            DataForPut dataForPut = new DataForPut { accountId = 106080, comment = "", isCommitted = false, operationDate = "2020-02-25", value = 1234, items = items };
