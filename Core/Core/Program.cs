...
namespace Core
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AccountCreationRequest dataForPost = new AccountCreationRequest { Title = "console request", AccountBank = null, AccountBik = null, AccountType = "Cash", AccountAcct = null, Active = true, CompanyId = 41104, CurrencyCode = "USD", Description = null, LongTitle = "", Remainder = 0, RemainderDate = "2020-03-02" };
